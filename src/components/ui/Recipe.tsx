    ...
    <div className={styles.recipe__wrapper}>
      <header className={styles.recipe__header}>
        {isPreview && onPreviewClose ? (
          <button
            className={styles.recipe__preview}
            type="button"
        ...
        {isOwner && !isPreview ? (
          <div className={styles.recipe__controls}>
            <button
              className={styles.recipe__toggle}
              type="button"
            ...
            <div
              className={`${styles.recipe__overlay} ${
                userControls ? styles.recipe__overlay__active : ''
              }`}
            />

            <ul
              className={`${styles.recipe__options} ${
                userControls ? styles.recipe__options__active : ''
              }`}
            >
              <li className={styles.recipe__option}>
                <Link
                  className={styles.recipe__option_item}
                  href={`/recipe/${id}/edit`}
                >
                  Edit
                </Link>
              ...
              <li
                className={`${styles.recipe__option} ${styles.recipe__option__mobile}`}
              >
                <button
                  className={styles.recipe__option_item}
                  type="button"
        ...
        <div className={styles.recipe__img_wrapper}>
          <Image
            fill={true}
        ...
        <div className={styles.recipe__tools}>
          <FavoriteButton
        ...
        <div className={styles.recipe__summary}>{summary}</div>
        ...
        <div className={styles.recipe__stats}>
          <span className={styles.recipe__cook}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              className={styles.recipe__cookicon}
              viewBox="0 0 24 24"
            >
          ...
          <span className={styles.recipe__prep}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <Link
          className={styles.recipe__author}
          href={`/account/profile/${author}`}
        >
          <div className={styles.recipe__author_img_wrapper}>
            <Image
              className={styles.recipe__author_img}
              fill={true}
              src={authorImage}
              alt="User Profile"
            />
          </div>
          <div className={styles.recipe__author_name}>{authorName}</div>
          <div className={styles.recipe__arrow} />
        </Link>
      </header>

      <div className={styles.recipe__ingredients}>
        <h2 className={styles.recipe__subtitle}>Ingredents</h2>

        <ul
          className={`${styles.recipe__list} ${styles.recipe__list__ingredients}`}
        >
          {ingredients.split('\n').map((ingredient: string) => (
            <li
              key={`ingredient-${ingredient}`}
              className={`${styles.recipe__item}${styles.recipe__item__ingredient}`}
            >
              {ingredient}
            </li>
          ))}
      ...
      <div className={styles.recipe__directions}>
        <h3 className={styles.recipe__subtitle}>Directions</h3>
        <ul
          className={`${styles.recipe__list} ${styles.recipe__list__direction}`}
        >
          {directions.split('\n').map((step: string, index: number) => (
            <li
              key={index}
              className={`${styles.recipe__item} ${styles.recipe__item__direction}`}
            >
              <span className={styles.recipe__step}>Step {index + 1}</span>
              {step}
            </li>
          ))}
        </ul>
      ...
      <div className={styles.recipe__facts}>
        <h2 className={styles.recipe__subtitle}>Nutrition Facts</h2>

        <div className={styles.recipe__nutrition}>
          <ul
            className={`${styles.recipe__list} ${styles.recipe__list__facts}`}
          >
            <li
              className={`${styles.recipe__item} ${styles.recipe__item__facts} ${styles.recipe__items__missing}`}
            >
